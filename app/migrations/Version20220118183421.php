 ...
 */
final class Version20220118183421 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE episode_downloads (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', episode_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', occured_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_F5B1328C362B62A0 (episode_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE episode_downloads ADD CONSTRAINT FK_F5B1328C362B62A0 FOREIGN KEY (episode_id) REFERENCES episodes (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE episode_downloads DROP FOREIGN KEY FK_F5B1328C362B62A0');
